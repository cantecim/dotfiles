...
A. Strictly follow the loaded skill's workflow.
...
A1. Announce the skill

- You MUST always announce the skill you use, every time.

B. Subagents are always allowed within this conversation.
...
D. Strictly follow all listed principles
