COMPUTER_NAME="Can Tecim"
LANGUAGES=(en-US tr-TR)
LOCALE="en_TR@currency=USD"
...
# Set standby delay to 1:30 hours (default is 1 hour)
sudo pmset -a standbydelay 5400 

# Disable Sudden Motion Sensor
# sudo pmset -a sms 0 # I don't find this useful anymore esp. since newer macs doesn't have any HDD, it is better not turn off a safety sensor
...
defaults write com.apple.dock wvous-bl-corner -int 11   # bottom left Launchpad
defaults write com.apple.dock wvous-bl-modifier -int 0
defaults write com.apple.dock wvous-br-corner -int 3    # bottom right Application Windows
